// 自动生成的文件，请勿手动修改
import * as entity0 from './modules/user/entity/info';
import * as entity1 from './modules/task/entity/log';
import * as entity2 from './modules/task/entity/info';
import * as entity3 from './modules/space/entity/type';
import * as entity4 from './modules/space/entity/info';
import * as entity5 from './modules/recycle/entity/data';
import * as entity6 from './modules/plugin/entity/info';
import * as entity7 from './modules/dict/entity/type';
import * as entity8 from './modules/dict/entity/info';
import * as entity9 from './modules/demo/entity/goods';
import * as entity10 from './modules/catalog/entity/goods';
import * as entity11 from './modules/catalog/entity/category';
